...
#if !defined(PUREMVC_PATTERNS_OBSERVER_NOTIFICATION_HPP)
#define PUREMVC_PATTERNS_OBSERVER_NOTIFICATION_HPP
...
#endif /* PUREMVC_PATTERNS_OBSERVER_NOTIFICATION_HPP */
