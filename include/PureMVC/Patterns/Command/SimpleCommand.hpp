...
#if !defined(PUREMVC_PATTERNS_COMMAND_SIMPLE_COMMAND_HPP)
#define PUREMVC_PATTERNS_COMMAND_SIMPLE_COMMAND_HPP
...
#endif /* PUREMVC_PATTERNS_COMMAND_SIMPLE_COMMAND_HPP */
